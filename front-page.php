                        ...
                        <div class="row">
                            <div class="col-lg-12 align-self-center">
                                ...
                                <div class="slide-item-img">
                                    <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/slider/21.png" alt="#">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-img-wrap about-img-left">
                        <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/others/7.png" alt="About Us Image">
                        <div class="about-us-img-info about-us-img-info-2 about-us-img-info-3">
                            
                            <div class="ltn__video-img ltn__animation-pulse1">
                                <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/others/8.png" alt="video popup bg image">
            ...
            <div class="row">
                        ...
                        <ul class="ltn__list-item-2 ltn__list-item-2-before--- ltn__list-item-2-img mb-50">
                            <li>
                                <a href="img/img-slide/11.jpg" data-rel="lightcase:myCollection">
                                    <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/img-slide/11.jpg" alt="Image">
                                </a>
                            </li>
                            <li>
                                <a href="img/img-slide/12.jpg" data-rel="lightcase:myCollection">
                                    <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/img-slide/12.jpg" alt="Image">
                                </a>
                            </li>
                            <li>
                                <a href="img/img-slide/13.jpg" data-rel="lightcase:myCollection">
                                    <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/img-slide/13.jpg" alt="Image">
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-img-wrap about-img-right">
                        <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/others/9.png" alt="About Us Image">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                        <div class="ltn__feature-icon">
                            ...
                            <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/icons/icon-img/21.png" alt="#">
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1 active">
                        <div class="ltn__feature-icon">
                            ...
                            <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/icons/icon-img/22.png" alt="#">
                        </div>
                        <div class="ltn__feature-info">
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                        <div class="ltn__feature-icon">
                            ...
                            <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/icons/icon-img/23.png" alt="#">
                        </div>
                        <div class="ltn__feature-info">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="apartments-plan-img">
                                            <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/others/10.png" alt="#">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="ltn__testimoni-info">
                            ...
                            <div class="ltn__testimoni-info-inner">
                                <div class="ltn__testimoni-img">
                                    <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/testimonial/1.jpg" alt="#">
                                </div>
            ...
            <div class="row ltn__brand-logo-active">
                <div class="col-lg-12">
                    <div class="ltn__brand-logo-item">
                        <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/brand-logo/1.png" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__brand-logo-item">
                        <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/brand-logo/2.png" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__brand-logo-item">
                        <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/brand-logo/3.png" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__brand-logo-item">
                        <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/brand-logo/4.png" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__brand-logo-item">
                        <img src="<?php echo esc_url(get_template_directory_uri(  ))?>/assets/img/brand-logo/5.png" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__brand-logo-item">
