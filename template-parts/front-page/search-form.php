        ...
        <div class="ltn__slide-item ltn__slide-item-2 ltn__slide-item-4 bg-image">
            <div class="ltn__slide-item-inner text-left">
                <div class="container">
                    <div class="row">
                        <?php
                        $page_inmueble = ci_validate_page_for_slug( 'inmuebles' );
                        if( $page_inmueble ):                                                
                        ?>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active show">
                                            <div class="car-dealer-form-inner">
                                                <form action="<?php echo esc_attr( esc_url( get_permalink( get_page_by_path( 'inmuebles' )->ID ) ) ); ?>" method="get" id="form-search-inmuebles-front-page" class="ltn__car-dealer-form-box row">
